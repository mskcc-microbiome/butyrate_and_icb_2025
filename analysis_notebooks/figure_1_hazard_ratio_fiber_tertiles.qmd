...
ggsave("figures/svg/pfs_tertitle_plot.svg", plot = pfs_plot_to_save, w = 2.5, h = 3)
```
...
os_plot <- ggsurvplot(kmOS_tert,risk.table=F,
           ...
           #legend.title=element_blank(),
           legend="none",
           #legend.labs=c("0-33%", "33-66%", "66-100%"),
           #surv.median.line = "hv",
           conf.int=FALSE,
           break.x.by=6,
           axes.offset=FALSE,
...
ggsave("figures/svg/os_tertitle_plot.svg", plot = os_plot_to_save, w = 2.5, h = 3)
```
