...
[ShortBRED](https://huttenhower.sph.harvard.edu/shortbred/) is a tool developed by the Huttenhower group for profiling specific protein families of interest using shotgun metagenomic data.  Here is an image taken from [their paper](https://doi.org/10.1371/journal.pcbi.1004557)* explaining the process:

<img src="./images/shortbred_summary.png" width="90%" style="margin-left:5%"/>
