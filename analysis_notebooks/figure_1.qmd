...
This figure is largely concerned with fiber analysis in the Genito-unirinary survey cohort.
...
#mixed_solid_tumor <- readRDS("../data/mixed_solid_tumor.RDS") %>% sample_data %>% as.matrix %>% as.data.frame()
#external_melanoma <-
#external_rcc
